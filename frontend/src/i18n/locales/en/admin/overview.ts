export default {
    ...
    users: {
      ...
      customRatePlaceholder: 'Number or expression, e.g. $up * 1.05',
      customRateDynamic: 'Dynamic',
      customRateDynamicTitle: 'Dynamic rate expression evaluated against the account cost ($up); the number is only a fallback',
    ...
    groups: {
      ...
      rateInputHint: 'Number (custom rate) or dynamic expression, e.g. $up * 1.05; blank removes the override',
