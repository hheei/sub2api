export default {
  common: {
    ...
    rateSourceGroup: 'Group rate (no custom override for this account)',
    rateSourceCustom: 'Custom rate (overrides the group rate)',
    rateSourceCustomDynamic: 'Custom dynamic rate (overrides the group rate, tracks upstream cost)',
    save: 'Save',
