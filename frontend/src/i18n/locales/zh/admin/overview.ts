export default {
    ...
    users: {
      ...
      customRate: '专属倍率',
      useDefaultRate: '使用默认',
      customRatePlaceholder: '数值或表达式，如 $up * 1.05',
      customRateDynamic: '动态',
      customRateDynamicTitle: '动态倍率表达式按账号成本（$up）求值；数值仅为求值失败时的回退值',
    ...
    groups: {
      ...
      rateInputHint: '数值（专属倍率）或动态表达式，如 $up * 1.05；留空表示清除覆盖',
