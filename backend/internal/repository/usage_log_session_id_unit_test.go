...
// is immediately before is_dynamic_rate; created_at is always last.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// created_at is last; native_compaction_v2 precedes it; is_dynamic_rate precedes that;
	// session_id precedes is_dynamic_rate.
	...
	require.Equal(t, "boolean", usageLogInsertArgTypes[len(usageLogInsertArgTypes)-3],
		"is_dynamic_rate arg type must be boolean")
