...
const (
	...
	// FieldRateMultiplierExpr holds the string denoting the rate_multiplier_expr field in the database.
	FieldRateMultiplierExpr = "rate_multiplier_expr"
...
var (
	...
	// DefaultRateMultiplierExpr holds the default value on creation for the "rate_multiplier_expr" field.
	DefaultRateMultiplierExpr string
...
// ByRateMultiplierExpr orders the results by the rate_multiplier_expr field.
func ByRateMultiplierExpr(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRateMultiplierExpr, opts...).ToFunc()
}
