...
type Group struct {
	...
	// RateMultiplierExpr holds the value of the "rate_multiplier_expr" field.
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldRateMultiplierExpr, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldRateMultiplierExpr:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field rate_multiplier_expr", values[i])
			} else if value.Valid {
				_m.RateMultiplierExpr = value.String
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("rate_multiplier_expr=")
	builder.WriteString(_m.RateMultiplierExpr)
	builder.WriteString(", ")
